                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('Auth/proses_login_user') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <a href="<?= base_url('Auth/forgot_pass') ?>" class="forgot-password-link">Lupa Kata Sandi?</a>
                            <p class="login-card-footer-text">Belum memiliki akun? <a href="<?= base_url('Auth/register_user') ?>" class="text-reset">Daftar disini</a></p>
